/**
*
* ThreeColorHanoi.java - Three Stack implementation of Towers of Hanoi
*
* @author Brian Etzel
* @version 1.0
*/
...
public class ThreeColorHanoi extends JPanel implements MouseListener, MouseMotionListener, ActionListener{
	...
	*/
    public ThreeColorHanoi(int _numDisks) 
	{
	...
	*/
	...
	{
		Color colors[] = {Color.DARK_GRAY, Color.WHITE, Color.RED, Color.DARK_GRAY, Color.WHITE, Color.RED, Color.DARK_GRAY, Color.WHITE};
		Color colorsStackTwo[] = {Color.WHITE, Color.RED, Color.DARK_GRAY, Color.WHITE, Color.RED, Color.DARK_GRAY, Color.WHITE, Color.RED};
		Color colorsStackThree[] = {Color.RED, Color.DARK_GRAY, Color.WHITE, Color.RED, Color.DARK_GRAY, Color.WHITE, Color.RED, Color.DARK_GRAY};
		...
		for (int i = 0; i < numDisks; i++) {
			...
			int diskWidth = (numDisks * DISK_WIDTH_FACTOR) - (20 * i);
			disk.setFrame(STARTING_X * 5 - diskWidth / 2, STARTING_Y - (i * 20), diskWidth, 20);
			towerStack[2].push(disk);
			diskColor[2].push(colorsStackThree[i]);
