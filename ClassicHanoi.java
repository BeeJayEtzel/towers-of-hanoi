/**
*
* ClassicHanoi.java - Classic Implementaion of Towers of Hanoi
*
* @author Brian Etzel
* @version 1.0
*/
...
public class ClassicHanoi extends JPanel implements MouseListener, MouseMotionListener, ActionListener{
	...
	*/
    public ClassicHanoi(int _numDisks) 
	{
	...
	*/
	...
	{
		Color colors[]={Color.RED, Color.ORANGE, Color.YELLOW, Color.GREEN, Color.BLUE, Color.MAGENTA, Color.DARK_GRAY, Color.WHITE, Color.CYAN};
